...
if(isset($_POST['submit']) ) {
	...
	if(!empty($_POST['context']) && !empty($_POST['desc']) && !empty($_POST['milestone']) && !empty($_POST['time']) && !empty($_POST['msg']) ) {
		...
		if (mysqli_affected_rows($dbc) ==1 ) {
			...
			$noerror = '<span class="noerr">Your Scheduler will respond this way!</span><br />
...
<div class="require"<?php if(isset($_SESSION['scherror']) ) { /*do nothing*/ }else{ echo 'style=" display:none"'; } ?> >
