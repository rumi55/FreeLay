...
if($_REQUEST['action'] == 'outgoing') {
	...
	$s = "SELECT * FROM sms WHERE agent_phone LIKE '$gateway%' AND status='0' ORDER BY modified_date ASC LIMIT 500";
	...
	exit();
		...
		$message = "No queued messaged in the DB:SMS as at ".date('D d M g:ia');
